...
var file_nadzornaRavnina_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_nadzornaRavnina_proto_depIdxs = []int32{
	...
	4, // 2: controlplane.ControlPlane.GetClusterState:input_type -> google.protobuf.Empty
	2, // 3: controlplane.ControlPlane.RegisterNode:input_type -> controlplane.RegisterNodeRequest
	1, // 4: controlplane.ControlPlane.GetClusterState:output_type -> controlplane.GetClusterStateResponse
	3, // 5: controlplane.ControlPlane.RegisterNode:output_type -> controlplane.RegisterNodeResponse
